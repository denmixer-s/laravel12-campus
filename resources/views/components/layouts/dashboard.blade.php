...
<body class="antialiased text-gray-800 bg-gray-100 dark:bg-gray-900 dark:text-gray-200" x-data="{
                ...
                <div class="p-6">
                    ...
                    @session('status')
                        <div x-data="{ showStatusMessage: true }" x-show="showStatusMessage"
                            ...
                            class="p-4 mb-6 border-l-4 border-green-500 rounded-md bg-green-50 dark:bg-green-900">
