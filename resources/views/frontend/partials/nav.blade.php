<header class="shadow-md bg-white tracking-wide relative z-50">
    <section class="py-2 bg-[#007bff] text-white text-right px-10">
        <p class="text-sm"><span class="mx-3 font-semibold">Address:</span>SWF New York 185669<span
                class="mx-3 font-semibold">Contact
    ...
    <section
        ...
        <div
            class="left-10 absolute z-50 flex items-center px-4 py-2.5 rounded max-lg:hidden focus-within:bg-transparent">
    ...
    <div class="flex flex-wrap justify-center sm:px-10 px-4 py-3 relative">
        ...
        <div id="collapseMenu"
            ...
            <ul
                ...
                <li class="max-lg:border-b max-lg:border-gray-300 max-lg:px-3 max-lg:py-3"><a href='javascript:void(0)'
                        class="hover:text-blue-700 text-blue-700 block font-medium text-[15px]">Home</a></li>
                <li class="group max-lg:border-b max-lg:border-gray-300 max-lg:px-3 max-lg:py-3 relative">
                    <a href='javascript:void(0)'
                        class="hover:text-blue-700 hover:fill-blue-700 text-slate-900 font-medium text-[15px] flex items-center">Store<svg
